...
def main_page():
    ...
    def register():
        ...
        phno = StringVar() 
        rights =  IntVar()
        labl = Label(screen2, text="Please enter user information", width="30")
        labl.grid(row=1, column=1, padx=5, pady=5, columnspan=1)
        labl = Label(screen2, text="Username", width='30')
        ...
        labl = Label(screen2, text="Email ID", width='30')
        ...
        labl = Label(screen2, text="Phone Number", width='30')
        ...
        labl = Label(screen2, text="Rights", width='30')
        labl.grid(row=8, column=1, padx=5, pady=5, columnspan=1)        
        opt1_entry = Radiobutton(screen2, variable=rights, value="Admin", width="10", state=NORMAL, anchor="w", text="Admin")
        opt1_entry.grid(row=9, column=1, padx=5, pady=5, columnspan=1)
        opt2_entry = Radiobutton(screen2, variable=rights, value="User", width="10", state=NORMAL, anchor="w", text="User")
        opt2_entry.grid(row=10, column=1, padx=5, pady=5, columnspan=1)     
        labl = Label(screen2, text="Password", width='30')
