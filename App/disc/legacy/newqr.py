...
qrevent = StringVar()
global btn, bnt
btn = Button(width=13, text="QR Generator", command=CreateWidgets)
btn.grid(row=7, column=2, padx=5, pady=5, columnspan=1)
bnt = Button(width=13, text="QR Scanner", command=app)
bnt.grid(row=8, column=2, padx=5, pady=5, columnspan=1)
root.mainloop()
